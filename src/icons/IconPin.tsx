...
import {MarkerIconsProps, onClickProps, StylesValues} from "../types/interfaces";
...
interface IWrapperProps {
  pinIconStyles: StylesValues;
}

interface IProps extends MarkerIconsProps {
  pinIconStyles: StylesValues;
  onClick: ({item, type}: onClickProps) => void;

}

const IconPin = ({ item, onClick, pinIconStyles }: IProps) => {
  const { count } = item;
  return (
    <Wrapper pinIconStyles={pinIconStyles} onClick={() => onClick({ item, type: "country" })}>
