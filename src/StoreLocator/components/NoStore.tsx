...
import {Styles, StylesValues} from "../../types/interfaces";
...
const ExpandButton = styled.button<IExpandButtonProps>`
  margin-top: 50px;
  text-transform: uppercase;
  ${({ expandButtonStyles }) =>
    expandButtonStyles &&
...
interface IExpandButtonProps {
  expandButtonStyles: StylesValues;
}

interface IProps {
  getNearestDivvyStation: () => void;
  expandButtonStyles: Styles;
}

const StoresNoItem = ({ getNearestDivvyStation, expandButtonStyles }: IProps) => {
